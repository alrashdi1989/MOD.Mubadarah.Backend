        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArabicName = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    EnglishName = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    MainUnitArabic = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    MainUnitEnglish = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    PositionArabic = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    PositionEnglish = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    PositionUnitId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    RankArabic = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    RankEnglish = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    RankOrder = table.Column<int>(type: "int", nullable: false),
                    ServiceNumber = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
